...
model = joblib.load('house_trained_model.pkl')


# Drop in an example data entry
# The massive number of variables is the result of one-hot encoding from pd.get_dummies
...
predicted_property_value = model.predict(property_to_value)
predicted_property_value = predicted_property_value[0]

print ("This property has an estimated value of AUD /$: %.2f" % predicted_property_value)
